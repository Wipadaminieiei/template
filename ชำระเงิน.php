		...
		<div id="page-wrapper">
			...
			<!-- Header -->
				...
				<section id="banner">
  				...
  				<p><h4>ยืนยันตัวตน</h4><label><center><input class="w3-input w3-border w3-red" type="text" style="width:50%"></label></center>
  				</br>
  				<div class="12u$">
					<form name="form1" method="post" action="PageUploadToMySQL2.php" enctype="multipart/form-data">
	                  ...
	                  <br />
	                 	</br><center><h4><button class="w3-button w3-black w3-round-large"><a href="index.php">ยืนยันการชำระเงิน</button></h4>
	                 	</center>
					</form>
				</center>	<br /></h2>
		</div>
